...
//    Can successfully push onto a stack
    void pushIntoStack() {
        ...
        String therigh = "Stack{top=Node{value=1, pointerToNextNode=null}}";
...
//Can successfully dequeue out of a queue the expected value
    ...
    void sequeue(){
        ...
        String testex="Node{value=1, pointerToNextNode=Node{value=7, pointerToNextNode=null}}";
        assertEquals(testex,stackNumbers.dequeue().toString());
    }
